...
function FavoriteButton(props) {
  const [favoritesScan, setFavoritesScan] = useState([]); //Data from the backend is stored in the state, this is for scaning items that are already in your favourites list.
  ...
  const addToFav = (e) => {
    ...
    // Scans the tacks in your favorites list to see if you already have this track. If not, it will be added. If you already have it in your favourites list. the browser will not add that track.
